define([
	...
	return declare(null, {
		...
		//		Unlike ValidationTextBox, leading ^ and trailing $ are not added automatically.
		...
		constructor: function(/*===== params, srcNodeRef =====*/){
			...
			this.constraints = {};
			this.baseClass += ' gjaxValidationTextarea';
		},
		...
		postMixInProperties: function(){
			this.inherited(arguments);
			this.messages = i18n.getLocalization("dijit.form", "validate", this.lang);/* git-qa */
